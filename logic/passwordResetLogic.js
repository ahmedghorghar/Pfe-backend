...
const Token = require("../model/token.model"); // Assuming model is in parent directory

const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "here you can put your email",
    pass: "here you can put your app password generated by gmail",
  },
});
...
class Passwordreset {
  async sendVerificationCode(req, res) {
    ...
    try {
      ...
      const mailOptions = {
        from: "here you can put your email",
        to: email,
